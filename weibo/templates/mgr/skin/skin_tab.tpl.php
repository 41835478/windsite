...
<body class="main-body">
	...
	<div class="main-cont clear">
       ...
       <?php if(XT_USER_NICK=='fxy060608'){ ?><h3 class="title"><a class="btn-general" href='<?php echo URL('mgr/skin.getAllSkinSort');?>'><span>类别管理</span></a>所有可用的皮肤</h3><?php } ?>
		<div class="set-area">
