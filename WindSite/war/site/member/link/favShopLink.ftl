...
<ul>
<li class="selected" t="0"><img id="checkedImg" src="http://static.xintaonet.com/assets/images/link/checked.gif" style="position:absolute;"/><img src="http://static.xintaonet.com/assets/images/link/shop-street.gif"/></li>
</ul>
...
<label><input type="radio" name="group_order" value="2">佣金比例从高到低</label>
...
<fieldset>
    ...
    <#assign site=USER.sites[0]>
    	<tr><td><input name="txtlinkRadio" id="txtlinkRadio1" type="radio" value="url" title="http://<#if site.www??&&site.www!=''>${site.www}<#else>${site.domainName}.xintaonet.com</#if>/tfavshop.html" checked>&nbsp;&nbsp;<label for="txtlinkRadio1">URL推广</label></td></tr>
    	<tr><td><input name="txtlinkRadio" id="txtlinkRadio2" type="radio" value="txtlink" title="淘宝店铺精选" url="http://<#if site.www??&&site.www!=''>${site.www}<#else>${site.domainName}.xintaonet.com</#if>/tfavshop.html">&nbsp;&nbsp;<label  for="txtlinkRadio2">淘宝店铺精选</label></td></tr>
    	<tr><td><input name="txtlinkRadio" id="txtlinkRadio3" type="radio" value="customelink" url="http://<#if site.www??&&site.www!=''>${site.www}<#else>${site.domainName}.xintaonet.com</#if>/tfavshop.html">&nbsp;&nbsp;<label for="txtlinkRadio3">自定义：</label><input id="txtlinkInput" style="width:350px;padding:5px;" disabled value="淘宝店铺精选"></a></td></tr>
    </table>
</fieldset><br/>
