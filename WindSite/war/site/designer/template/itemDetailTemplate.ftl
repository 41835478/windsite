					...
					<div class="xt-key">
						<div class="xt-skin xt-naked">
							<div class="xt-action xt-clearfix" style="margin-left:20px;">
								...
								<div class="xt-btn-buy"><a href="${detail.shopClickUrl}" class="fl-link" target="_blank" style="width:170px;"><img src="/assets/min/stylesheets/images/gozhanggui.gif"></a></div>
							</div>
						</div>
					</div>
				</div>
