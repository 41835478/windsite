...
<body class="main-body">
	<div class="path"><p>当前位置：推广统计<span>&gt;</span>淘客收入</p></div>
    <div class="main-cont">
        <h3 class="title">您的淘宝帐号[<strong style="color:red;font-size:16px;"><?php echo XT_USER_NICK;?></strong>]对应的PID是<strong style="color:red;font-size:16px;"><?php echo XT_USER_PID;?></strong></h3>
		<div class="set-area">
