...
public class ClassUtil {
	...
	public static List<String> getClassListFromPackage(String packageName) {
		...
		for (String classpath : classPaths) {
			...
			if (classpath.endsWith(".jar")) {
				...
				File dir = new File(classpath + File.separatorChar
						+ packagePath);
	 ...
	 * @return
	 */
	public static <A extends Annotation> List<Class<?>> getClassListFromPackageByAnnotation(
			Class<A> annotationType, String packageName) {
