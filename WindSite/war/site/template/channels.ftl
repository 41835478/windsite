<style>#channel-nav{background: #FED98A;}.rc-tp,.bd {background: url(/assets/min/images/shops_header_bg.png) no-repeat -999em 0px;}.rc-tp{background-position: -96px -428px;display: block;height: 30px;margin-bottom: -30px;position: relative;}.rc-bt {background-position: -96px -424px;display: block;height: 4px;margin-top: -4px;position: relative;}.bd {background-position: 0px -459px;background-repeat: repeat-x;border-bottom: none;border: 1px #F69968;height: 33px;}.trade {float: left;font-size: 14px;line-height: 33px;margin-top: 3px;overflow: hidden;padding-left: 5px;position: relative;}
#channel-nav ul{list-style:none;margin:5px;margin-top:0px;}#channel-nav li{float:left;background-position: 100% -523px;color: white;height: 30px;margin: 0px -2px 0px 2px;}#channel-nav dd{float: left;}#channel-nav li a{color:white;float: left;font-weight: 700;padding: 0px 0px 0px 7px;background: url(/assets/min/images/shops_header_bg.png) no-repeat -999em 0px;}#channel-nav li a:hover{color: #FFEA00;}.cats_list li a:hover{color:#F60;}#channel-nav li a span{font-size:12px;cursor: pointer;float: left;height: 30px;line-height: 28px;overflow: hidden;padding: 0px 10px 0px 0px;background: url(/assets/min/images/shops_header_bg.png) no-repeat -999em 0px;}</style>
