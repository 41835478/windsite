<table width=100%><tr><td width=200px align=right><label class="fm-label" for="sortOrder"><span class="required">*</span>显示顺序：</label><input type="text"  required="required" class="i-text" id="sortOrder" name="sortOrder" value="0" style="width:50px;"></td><td  align=right><label for="title" class="fm-label"><span class="required">*</span>版块名称：</label><input type="text"  required="required" minlength="3" maxlength="20" class="i-text" id="title" name="title" value=""></td></tr>
<tr><td width=200px align=right><label class="fm-label" for="blogClass"><span class="required">*</span>关联日志分类：</label><input readonly  style="background:#9C9C9C;width:50px;" type="text"  required="required" class="i-text" id="blogClass" name="blogClass" value=""></td><td  align=right><label for="classTitle" class="fm-label"><span class="required">*</span>分类名称：</label><input  readonly  style="background:#9C9C9C;" type="text"  required="required" minlength="3" maxlength="20" class="i-text" id="classTitle" name="classTitle" value=""></td></tr>
