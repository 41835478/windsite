<div class="shop-blog cmsview-list-line">
	...
	<div class="bd">
		...
		<#else>
		<#assign filePath = SITEIMPL.user_id?substring(SITEIMPL.user_id?length-2,SITEIMPL.user_id?length)>
		<!--#include virtual="/zone/${filePath}/${SITEIMPL.user_id}/module/${MODULEID}.html"-->
		</#if>
	</div>
</div>		