...
<div class="form-row source">
    ...
    <div class="form-cont">
		<p class="input-item">
			从<input class="input-txt w30" type="text" name="param[start_commissionRate]" vrel="bt=min:0,max:50,m:范围为0-50|int=m:只能输入数字" warntip="#commissionrateErr" value="0">%&nbsp;&nbsp;
			到<input class="input-txt w30" type="text" name="param[end_commissionRate]" vrel="bt=min:0,max:50,m:范围为0-50|int=m:只能输入数字" warntip="#commissionrateErr" value="50">%
