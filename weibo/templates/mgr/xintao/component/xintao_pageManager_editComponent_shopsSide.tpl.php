       <?php TPL :: module('xintao/component/taokeShopsEdit', array('data'=>$data,'pmId'=>$pmId,'component'=>$component,'page'=>$page,'page_id'=>$page_id));?>
		<div class="form-row">
			<label for="number2" class="form-field">显示数量</label>
			<div class="form-cont">
		...
		<div class="form-row source0<?php if ($data['param']['source']==1){ echo ' hidden'; }?>">
