...
<?php }?>					
	...
	<div class="health-side">
		...
		<ul style="margin-top:10px;">
			<li>
				2012-5-11：<br/>
				微购升级服务器同时搬迁至海外，如果部分用户无法访问，请重启自己的路由器测试！已绑定独立域名且未使用cname(别名)指向www.xintaowang.com的站长，请尽快解除A记录解析，同时换成cname解析<br/>
				2012-3-24：<br/>
				针对卖家服务会员，开放商品营销(卖家)关闭自动挑选，开启自动挑选功能，进入商品营销(卖家)---自动挑选，卖家服务会员可根据自己的需要，关闭或开启自动挑选，默认为开启状态<br/>
