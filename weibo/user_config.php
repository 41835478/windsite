...
define('APP_FLAG_VER',	'0719145742');
/// MC　KEY　的前缀
...
define('DB_USER',		'windsite');
define('DB_PASSWD',		'windsite');
define('DB_CHARSET',	'utf8');
define('DB_PREFIX',		'xwb_');
//define('DB_NAME',		'');
define('DB_NAME',		'xwb');
//----------------------------------------------------------------------
...
define('LOG_DB_WARNING_TIME', 3);
define('LOG_IO_WARNING_TIME', 3);
define('LOG_MC_WARNING_TIME', 3);
define('LOG_API_WARNING_TIME', 5);
//----------------------------------------------------------------------
