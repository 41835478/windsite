<div id="header">
    ...
    <div class="inner-nav" id="xwbInnerNav">
		...
		<span class="defined-link">
        	<a href="/">首页</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('pub')?>">微博</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('items')?>">购物</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('wow')?>">分享</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('posters')?>">画报</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('tv.search')?>">影视</a>|
        	<a href="http://<?php echo XT_SITE_DOMAIN.URL('sitemap')?>">网站地图</a>
		</span>
        <div class="nav-right">
		...
		?>
			...
			<?php }?>
                <?php
			if (1==USER::get('isAdminAccount')){
				LO('include__header__centralAdmin', W_BASE_URL_PATH.'admin.php');
			}elseif(USER::get('isAdminAccount')>1){
				LO('include__header__centralAdmin', TB_BACK_CONTAINER);
			}
			?>
	...
	<div class="hd-in">
		...
		<div id="shop-head" style="padding-top:8px;">
			...
			?>
				...
				<?php if(XT_IS_SELLER=='true'&&$_SERVER['SERVER_NAME']!='www.xintaowang.com'){Xpipe :: pagelet('xintao.headerSearch');} ?>
