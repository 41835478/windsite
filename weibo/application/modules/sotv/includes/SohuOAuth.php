...
class SohuOAuth {
	...
	public $host = "http://api.tv.sohu.com/";
	/* Set timeout default. */
	public $timeout = 30;
	/* Set connect timeout. */
	 ...
	 * 设置OAuth认证需要的Urls
	 */
	function accessTokenURL()  { return 'http://api.tv.sohu.com/oauth/access_token'; }
	function authenticateURL() { return 'http://api.tv.sohu.com/oauth/authorize'; }
	function authorizeURL()    { return 'http://api.tv.sohu.com/oauth/authorize'; }
	function requestTokenURL() { return 'http://api.tv.sohu.com/oauth/request_token'; }
