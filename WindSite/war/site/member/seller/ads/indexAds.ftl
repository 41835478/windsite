...
<input type="hidden" id="planId" value="<#if plan??>${plan.id}</#if>"/>
	<ul id="status">
		<li><a href="/router/member/selleradsmanager/plan/index" style="color:#f60;">返回广告列表</a></li>
	...
	<div class="items">
		<div class="step firstStep">
			...
			<tr><td width=100px height=30px><a href="/router/member/selleradsmanager/plan/index" class="button">返回</a> </td><td><a href="#" id="firstNext" class="button">下一步</a> </td></tr>
			</table>
		</div> 
	...
	<div><span class="k">佣金:</span><span class="v">${i.commission}</span></div><img class="customechecked" src="/assets/images/delete.gif"/></div>
			...
			<ul> 
				<li class="clearfix"> 
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" id="finish" class="button" ptype="index">完成</a> 
				</li> 
				<br clear="all" /> 
			</ul> 
		</div> 
