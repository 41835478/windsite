...
<div class="layout <#if site_detialLayout??&&site_detialLayout!=''>${site_detialLayout}<#else>grid-s5m0</#if> ks-clear">
	<div class="col-main">
		<div class="main-wrap J_TRegion">
				...
				<div class="shop-custom no-border">
					<div class="bd">
						<ul class="tabbar" id="XT_TabBar">
							...
							<li data-box="XT__ReviewsBox"><a href="javascript:;">评价详情(<em class="XT__ReviewsCount">${totalResults}</em>)</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div id="XT_DescriptionBox" name="shopCustom" class="box J_TBox ks-clear">
				<div class="shop-custom no-border">
					<div class="hd" style="display:none;"><h3><span>宝贝详情</span></h3></div>
					<div class="bd">
			...
			<#if rates??&&rates?size!=0><#list rates as r><tr><td class="cmt"><p style="" class="rate">${r.content}</p><p class="cmtInfo"><span class="date">[${r.created?datetime}]</span></p></td><td class="buyer"><p>${r.nick}</p></td></tr></#list></#if>
							...
							<tfoot><tr><td colspan="5"><div class="tm-pagination"><a class="tm-page-next" href="/gitem/${item.numIid}.html" target="_blank">查看更多&gt;&gt;</a> </div></td></tr></tfoot>
						</table>
						</#if>
					</div>
				</div>
	...
	<div class="col-sub J_TRegion">
		...
		<#if file.exists()>
			<#include  "//"+filePath+"/"+user_id+"/detail.html" parse=false encoding="utf8">
		<#else>
			...
			<div class="shop-category">
				...
				<div class="bd">
					<ul class="cats J_TWidget">
						...
						<li class="cat expand"><ul class="cat-bd"><li><a target="_blank" href="/search?cid=50025430">男鞋/皮鞋/休闲鞋</a></li></ul></li>
...
<@p.pageFooter>
var SELLERNICK='${item.nick}',CID='${item.cid}';
<#if pid??&&pid!=''>
_gaq.push(['_trackEvent', 'xt-${pid}', 'item-${item.nick}-${item.numIid}', '${item.title}']);
</#if>
$(function(){
