...
<tr><td class="key">淘宝交易号:</td><td class="value"><input type="text" class="i-text" id="trade-id" value=""></td><td class="key">返利金额:</td><td class="value" style="color:red;font-weight:700">${report.commission?number*MEMBER.commissionRate/100}</td></tr>
...
<tr><td class="key">交易号:</td><td class="value">${tradeNum[0]+'************'+tradeNum[tradeNum?length-1]}</td><td class="key">商品名称:</td><td class="value" style="width:auto;" colspan=3><a href="/titem/${report.num_iid}.html" target="_blank" style="color:#0166FF;">${report.item_title}</a></td></tr>
