...
<form id="addForm" action="<?php echo URL('mgr/page_manager.doCreateComponent');?>" method="post"  name="changes-newlink">
	...
	<div id="componentPropertyDiv">
			  ...
			  <div class="form-cont">
			  	  <p class="input-item">
					  <label for="source_get1">
						  <input class="r" type="radio" value="1" checked="checked" name="param[source]" onclick="javascript:$('#addForm .source0').addClass('hidden');$('#addForm .source1').removeClass('hidden');" id="source_get1">自动搜索
					  </label>
					  <label for="source_get2">
						  <input class="r" type="radio" disabled value="0" name="param[source]" onclick="javascript:$('#addForm .source1').addClass('hidden');$('#addForm .source0').removeClass('hidden');" id="source_get2">店铺分组
					  </label>
				  </p>
			  </div>
		</div>
		<div class="form-row source1">
		...
		<div class="form-row source0 hidden">
