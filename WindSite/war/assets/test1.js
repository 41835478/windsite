...
(function(a) {
	...
	MOGU.Album_Add_To_Album = function(f, g, d, e) {
		...
		a("#lb_addalbum .submit").click(function() {
			...
			a("#pub_out_check").attr("checked") == "checked" && (i = 1);
			c = {
				tid : f,
				imgType : g,
				imgId : d,
...
(function(a) {
	MOGU.Globe_Search_tip_Init = function() {
		if (a(".seatch_type_msearch").size() != 0) {
			...
			a(".top_search .ts_txt").focus(function() {
				var d = a("#top_search_form").offset().top + 33, b = a("#top_search_form")
						.offset().left;
				a("#seach_type").css({
							left : b,
							top : d
			...
			var b = a(".ts_txt"), h = b.attr("def-val");
			b.val(h);
			var e = 0, i = function(a, b) {
			...
			this.seacrh_tip_input_words = function() {
				if (window.saarch_tip_if_get_tip) {
					...
					var i = a(".ts_txt").val(), b = MGTOOL.getMsgLength(i);
					if (b == 0)
							...
							success : function(b) {
								if (b == null)
									...
									if (b.status.code == 1001) {
										var d = b.result.tipCount, b = b.result.tips, i = "";
										e = d;
										if (d == 0)
			...
			a(".top_search").focusin(function() {
				var d = a.trim(b.val());
				c && d != "" && d != h && a("#seach_type").show();
				b.unbind("keyup").unbind("input");
				b.bind("keyup", i).bind("input", i);
				...
				b.bind("keydown", function(b) {
					if (b.keyCode == "38") {
						...
						g--;
						g < 0 && (g = e - 1);
						var d = a("#seach_type .search_tip li:eq(" + g + ")")
					...
					b.keyCode == "40"
							&& (b.preventDefault(), g = a("#seach_type .search_tip li")
									...
									.removeClass("checked"), g++, g >= e
									&& (g = 0), (d = a("#seach_type .search_tip li:eq("
	...
	MOGU.Globe_Search_Box_Init = function() {
		if (a(".seatch_type_msearch").size() == 0) {
			...
			var b = a(".ts_txt"), h = b.attr("def-val"), e = function() {
			...
			a(".top_search").focusin(function() {
				var c = a.trim(b.val());
				c != "" && c != h && a("#seach_type").show();
				b.unbind("keyup").unbind("input").unbind("propertychange");
				b.bind("keyup", e).bind("input", e).bind("propertychange", e);
	...
	MOGU.Globe_Dropdown_List_Init = function(c, b, h, e, i, d) {
		var f = null;
		c.hover(function() {
			a(".s_m").hide();
			clearTimeout(f);
			var g = c.offset(), j = c.width(), k = c.height(), l = a(window)
					.width(), m = parseInt(c.css("padding-left").replace("px",
					"")), n = parseInt(c.css("padding-right").replace("px", "")), j = h
					? l - g.left - j - m - n
					: l - g.left - j - m;
			i ? d ? b.css({
						right : j + d.left,
	...
	MOGU.NavFixJia = function() {
		if (MOGUPROFILE.is_subsite == "1") {
			var c = !0, b = a("#navigation").height()
					+ parseInt(a("#navigation").css("margin-bottom")), h = a("#info_bar")
					.css("margin-bottom");
			a(window).scroll(function() {
	...
	MOGU.Nav_Shopping_Slide = function() {
		...
		if (c.size() != 0) {
			var b = a(".start_shopping"), h, e = b.offset().top + 36, b = b
					.offset().left;
			c.css({
						left : b,
						top : e
