...
<meta name="description" content="新淘网 - 我的新淘网,我是卖家,广告管理，首页广告计划">
<title>首页广告计划-广告管理-我是卖家-新淘网</title>
<script language="javascript" type="text/javascript" src="/assets/js/site/indexads.js?v=${dateVersion()}"></script>
</@ws.header>
<script>
$(function(){
	initPlanManager('index');
});
</script>
<style>
...
<@xt.sellertemplate navselected='seller' bdselected='ads-index'>
<#if (plans?size<USER.limit.indexAds)>
<a href="#" id="createPlan" class="button">新增计划</a>
<div style="height:2px;"></div>
</#if>
<@ws.info>
<span>
您的首页广告计划数量最高限额为<strong style='color:#D02200;font-weight:bold;'>${USER.limit.indexAds}</strong>  个，
您还可以添加 <strong style='color:#D02200;font-weight:bold;'>${USER.limit.indexAds-plans?size}</strong> 个
</span>
</@ws.info>
