...
class PromotionMealAddRequest
{
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->mealMemo,"mealMemo");
		RequestCheckUtil::checkNotNull($this->mealName,"mealName");
		RequestCheckUtil::checkMaxLength($this->mealName,30,"mealName");
		RequestCheckUtil::checkNotNull($this->mealPrice,"mealPrice");
		RequestCheckUtil::checkNotNull($this->typePostage,"typePostage");
	}
}
