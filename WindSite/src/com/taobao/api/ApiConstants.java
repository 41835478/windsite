...
public class ApiConstants {
	 ...
	 * 淘宝API沙箱环境入口
	 */
	public static final String API_SANDBOX_SERVICE_URL = "http://gw.api.tbsandbox.com/router/rest";

	/**
	 * 淘宝插件平台沙箱环境入口
	 */
	public static final String CONTAINER_SANDBOX_URL = "http://container.api.tbsandbox.com/container";
	...
	public static final String SKU_PROPERTIES_NAME = "sku_properties_name";
	public static final String ITEM_MEAL_NAME = "item_meal_name";
	public static final String ITEM_MEMO = "item_memo";
	public static final String TRADE_MEMO = "trade_memo";
	public static final String TRADE_SOURCE = "trade_source";
	public static final String DECREASE_STOCK = "decrease_stock";
	public static final String LOCATION_ID = "location.id";
	public static final String IS_ALLOW_ALIAS = "is_allow_alias";
	...
	public static final String LOGISTICS_FEE = "logistics_fee";
	...
	public static final String SELLER_AUTHORIZE = "authorizes"; // @see
																// SellerAuthorize
	...
	/**
	 * add by cilai 2010-02-23 TAOBAOAPI-1082
	 */
