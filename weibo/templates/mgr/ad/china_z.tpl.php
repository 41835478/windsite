...
<div class="set-wrap">
			...
			<div class="set-area-int set-area-init-pad">
            	<form method="post" action="">
                	...
                	<div class="focus-set">
                    	<p><strong>ChinaZ-Xintao weibo付费推广计划</strong></p>
						<p>1，您需要先加入ChinaZ-Xintao weibo付费推广计划方可开始使用Xintao weibo盈利；<a href="http://union.chinaz.com/userpages/xweiboapply.aspx?appkey=" target="_blank">点击申请</a></p>
