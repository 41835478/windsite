...
if ($item) {
	...
	$price = $item['price'];
?>
<title><?php echo $site.'正带您去'.$title.'['.$price.'元]-'.$site?></title>
<meta name="title" content="<?php echo $site.'正带您去'.$title.'['.$price.'元]-'.$site?>">
...
<title>最专业的淘宝商品购物导航 - <?php echo $site?></title>
<?php }?> 
<style type="text/css">
* {margin: 0;padding: 0;}
...
<div class="notice">
	<div class="ticket_location" id="jump_div"> 
			<div class="n_zone">
				...
				<p class="n_info"><?php echo $site?>正带您去<strong class="red"><?php echo $itemTitle?></strong>，请稍等。</p>
                <p class="n_info">
                    如果浏览器没有自动跳转，请
