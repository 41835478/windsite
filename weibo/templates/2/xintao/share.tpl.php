...
<div class="result-item">
	<div class="result-item-wrap">
		<div class="result-item-bd">
			...
			<div class="fx-brief">
				<div class="fxer-archive">
					<a class="fxer-avatar"><img src="<?php echo $row['archive_logo']?>" alt="<?php echo $row['archive']?>" width="30" height="30"></a>
					<dl>
						<dt><a><?php echo $row['archive']?></a></dt>
						<dd>分享</dd>
					</dl>
				</div>
				<div class="fx-cnt-bd ks-clear">
					<p class="fx-txts">
						<a href="/item/id-<?php echo $row['nid']?>" class="J_TrackItem" data-nid="<?php echo $row['nid']?>" target="_blank"><?php echo $row['weibo']?></a>
					</p>
		...
		<div class="result-item-ft">
			<a target="_blank" rel="nofollow" href="/item/id-<?php echo $row['nid']?>" class="J_TrackItem" data-nid="<?php echo $row['nid']?>" ><strong><?php echo $row['share_nums']?></strong>人购后分享</a> 
		</div>
	</div>
</div>		
<?php }?>
...
<?php echo $cat!='shop'?$pager->show('wow'.($cat?('.'.$cat):''), array('sub'=>$sub), 'bottom'):'';?>
<div class="ks-clear"></div>
</div>
</div>
