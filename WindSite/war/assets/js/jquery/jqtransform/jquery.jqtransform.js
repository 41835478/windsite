...
(function($) {
	...
	$.fn.jqTransInputText = function() {
		return this.each(function() {
			...
			$.browser.safari && $input.css('width', inputSize + 10 + 16);
	...
	$.fn.jqTransCheckBox = function() {
		return this.each(function() {
					...
					aLink.click(function() {
								...
								var firstONE = inputSelf.checked;
								// only original row
								$input.trigger('click').trigger("change");
								// second line of checking
								var secondOne = inputSelf.checked;
								if (firstONE == secondOne) {
									$input.attr('isAuto', true);
									inputSelf.click();
								}
								// for some strange reason - when it doesnt
								// change i change it instead...
