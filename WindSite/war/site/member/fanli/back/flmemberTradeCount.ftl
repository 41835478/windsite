...
<tbody>
<tr><td class="fl-num"><a class="a-num-un" href="/router/member/fl/trade?status=0&type=BUY">${unBuyFanli}</a></td><td class="fl-num"><a class="a-num-un" href="/router/member/fl/trade?status=0&type=ADS">${unAdsFanli}</a></td><td class="fl-num"><a class="a-num-wait" href="/router/member/fl/trade?status=1&type=BUY">${waitBuyFanli}</a></td><td class="fl-num"><a class="a-num-wait" href="/router/member/fl/trade?status=1&type=ADS">${waitAdsFanli}</a></td><td class="fl-num"><a class="a-num-finish" href="/router/member/fl/trade?status=2&type=BUY">${finishBuyFanli}</a></td><td class="fl-num"><a class="a-num-finish" href="/router/member/fl/trade?status=2&type=ADS">${finishAdsFanli}</a></td><td class="fl-num" rowspan=2>${allFanli}</td></tr>
<tr><td class="fl-num" colspan=2><a class="a-num-un" href="/router/member/fl/trade?status=0">${unBuyFanli+unAdsFanli}</a></td><td class="fl-num" colspan=2><a class="a-num-wait" href="/router/member/fl/trade?status=1">${waitBuyFanli+waitAdsFanli}</a></td><td class="fl-num" colspan=2><a class="a-num-finish" href="/router/member/fl/trade?status=2">${finishBuyFanli+finishAdsFanli}</a></td></tr>
</tbody>
</table>
