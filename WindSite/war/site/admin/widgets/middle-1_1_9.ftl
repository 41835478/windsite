            ...
            <ul class="custome-list custome-edit custome-num"><#list ldaip as l>
				...
				<table width=100%>
					...
					<td width=300px align=left><a class="title" href="${l.clickUrl}" target="_blank"><span>${l.title}</span></a><br/>
									<span class="level-desc">信用:</span><span class="level"><img src="http://static.xintaonet.com/assets/min/images/credit/${l.level}.gif"/></span><br/>
									<span class="seller-desc">掌柜:</span><span class="seller">${l.seller}</span></td>
					<td width=150px align=left><span class="price-desc">促销价:</span><span class="price">${l.price}</span><br/>
								<span class="volume-desc">最近成交:</span><span class="volume">${l.volume}</span></td>
					<td align=center><a class="title" href="${l.clickUrl}" target="_blank"><img alt="产品详情" src="http://static.xintaonet.com/assets/min/images/custome/buy_detail.jpg" border="0"></a></td>
					</tr>
				</table>
				</li></#list>
             </ul>
