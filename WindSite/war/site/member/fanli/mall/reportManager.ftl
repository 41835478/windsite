...
<title>商城交易-返利管理-我是淘客-新淘网</title>
<style>
</style>
</@ws.header>
...
<@xt.taoketemplate navselected='taoke' bdselected='fanli-mallReport' group=2>
<div id="getReport-dialog" title="手动获取订单">
<@ws.info>
<span style="color: #F60;">提醒:</span>&nbsp;&nbsp;手动获取订单时间段最多只能选择7天。已经获取了的交易记录将自动忽略。
</@ws.info>
<table width=100%>
	<tr>
...
<ol class="step step-four"><li><span>1.登录返利网站</span></li><li><span>2.商城交易</span></li><li><span>3.确认收货</span></li><li class="last"><span>返利</span></li></ol>
<div class="search-form">
	<fieldset>
		<legend>搜索</legend>
			<#if 'member'!=rel&&'trade'!=rel&&'item'!=rel><#assign rel='member'></#if>
			<ul class="search-tab" id="J_SearchTab" redirect="true">
				...
				<li class="<#if rel=="action">selected </#if>rel" rel="action"><s class="l"></s><s class="r"></s><a>活动编号</a></li>
				<li class="<#if rel=="trade">selected </#if>rel" rel="trade"><s class="l"></s><s class="r"></s><a>订单编号</a></li>
				<li class="<#if rel=="item">selected </#if>rel" rel="item"><s class="l"></s><s class="r"></s><a>商品编号</a></li>
			...
			<table id="fanli-filter">
				<tr><td height=25px>业绩状态：</td><td id="fanli-status-a"><a class="fanli-status selected" t="">全部</a>&nbsp;&nbsp;&nbsp;<a class="fanli-status" t="R">未确认</a>&nbsp;&nbsp;&nbsp;<a class="fanli-status" t="A">成功订单</a>&nbsp;&nbsp;&nbsp;<a class="fanli-status" t="F">无效订单</a></td></tr>
				<tr><td height=25px>跟单状态：</td><td id="fanli-follow-a"><a class="fanli-follow selected" t="-1">全部</a>&nbsp;&nbsp;&nbsp;<a class="fanli-follow" t="true">已跟单</a>&nbsp;&nbsp;&nbsp;<a class="fanli-follow" t="false">未跟单</a></td></tr>
			</table>
	</fieldset>
</div>
...
<@ws.help>
<h3>1.如何配置，才能使得新淘网的商城交易与亿起发联盟数据同步？</h3>
<p>第一步:<a href="http://home.xintaonet.com/space.php?uid=1&do=blog&id=12110" target="_blank">完成商城设置</a></p>
<p>第二步:<a href="http://home.xintaonet.com/space.php?uid=1&do=blog&id=12111" target="_blank">联系亿起发联盟客户经理，配置密钥及数据实时同步返回地址</a></p>
<h3>2.什么情况下会产生交易记录及返利记录？</h3>
<p>当您的返利网站会员以正常的返利流程完成购物，您的站点将同时产生交易记录，当交易确认后将产应对应的返利记录。如果您发现交易记录和返利记录出现问题，您可以手动获取指定时间的交易记录</p>
</@ws.help>
</@xt.taoketemplate>
