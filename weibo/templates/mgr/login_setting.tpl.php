...
<body id="login-set" class="main-wrap">
    ...
    <div class="main-cont">
    	<h3 class="title">请选择用户在Xintao weibo站点登录的方式</h3>
    	<div class="set-area">
        	<div class="form-s1">
                <form action="" method="post" id="loginWayForm">
                    <p class="tips"><strong>提示：</strong></p>
                    <p class="tips-s2">如果您只需要搭建一个Xintao weibo站点，请选择"仅使用新浪帐号直接登录"<br />
                    如果您已经搭建了其它网站，希望将新建的Xintao weibo站点与原有站点实现帐号绑定，请选择"使用新浪帐号与原有站点帐号并存方式登录"</p>
                    ...
                    <!--<div class="adapter">
                        ...
                        <p class="tip">还没完成哦！选择了帐号绑定适配器之后，您需要进行少许的设置才能实现帐号绑定功能。请参考<a href="">Xintao weibo开发人员文档</a></p>
                    </div>-->
                    <div class="btn-area">
                        <a href="javascript:$('#loginWayForm').submit();" class="btn-general highlight" name="保存修改"><span>保存修改</span></a>
                        <span class="form-tips">您可以开发与自己站点相匹配的帐号绑定适配器，请参考<a href="http://x.weibo.com/download_official.php" target="_blank">Xintao weibo开发人员文档</a></span>
                    </div>
                </form>
            </div>
        </div>
