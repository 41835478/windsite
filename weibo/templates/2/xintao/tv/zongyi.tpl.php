...
<style type="text/css">
.fi_movie .fi_jb{width:92px;height:92px;position:absolute;top:0;left:138px;background:url("http://static.xintaowang.com/css/default/xintao/xintaotv/zy-p.png") no-repeat;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true,sizingMethod=crop,src="http://static.xintaowang.com/css/default/xintao/xintaotv/zy-p.png");_background:none;}
</style>
</head>
