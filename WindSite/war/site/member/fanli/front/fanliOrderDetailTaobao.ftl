...
<tr><td class="key">订单编号:</td><td class="value"><input type="text" class="i-text" id="trade-id" value=""></td><td class="key">返利金额:</td><td class="value" style="color:red;font-weight:700">${report.commission?number*MEMBER.commissionRate/100}</td></tr>
