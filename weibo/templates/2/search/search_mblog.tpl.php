						...
						<div class="main">
                        	<div class="main-bd">
                                ...
                                <div class="title-info">
									...
									<a rel="nofollow" href="<?php echo URL('search.weibo','k=' . urlencode(V('r:k','')).'&base_app=' . V('r:base_app','') . '&filter_pic=2');?>" <?php if(V('r:filter_pic') == 2) {?>class="current"<?php }?>><?php LO('search__weibo__text');?></a> |
									<a rel="nofollow" href="<?php echo URL('search.weibo','k=' . urlencode(V('r:k','')).'&base_app=' . V('r:base_app','') . '&filter_pic=1');?>" <?php if(V('r:filter_pic') == 1) {?>class="current"<?php }?>><?php LO('search__weibo__pic');?></a>
