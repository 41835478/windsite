<div id="header">
    ...
    <div class="inner-nav" id="xwbInnerNav">
        ...
        <span class="defined-link">
        	<a href="/">首页</a>|
        	<a href="<?php echo URL('pub')?>">微博</a>|
        	<a href="<?php echo URL('items')?>">购物</a>|
        	<a href="<?php echo URL('posters')?>">画报</a>|
        	<a href="<?php echo URL('tv.search')?>">影视</a>
		</span>
        <div class="nav-right">
		...
		?>
			...
			}elseif(5==USER::get('isAdminAccount')){
