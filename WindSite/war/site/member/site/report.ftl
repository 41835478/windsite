...
<@xt.taoketemplate navselected='taoke' bdselected='income-report' group=5>
<table><tr><td>
日期：<input type="text" id="startDate">
<button id="select">查询</button></td>
</tr>
<tr><td>查询结果由淘宝提供，最终佣金收入以淘宝联盟为准</td></tr>
<tr><td>
