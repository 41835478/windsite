...
<body class="main-body">
    ...
    <div class="main-cont">
    	<h3 class="title">自动关注设置(<span class="stress">所有登录您微购站点的微博用户将自动关注，成为下列帐号的粉丝</span>)</h3>
        <div class="login-guide" id="panel">
			...
			<div class="set-area">
                ...
                <p class="tips-desc">
                <label for="matic">
                    <input id="matic" class="ipt-radio" name="auto_follow" id="auto_follow" type="checkbox" value="1"<?php echo $auto ? ' checked':'';?> />首次登录自动关注以下用户：<span class="stress">（最多添加3个自动关注用户，请慎用：可能会引起不好的体验）</span>
                </label>
                </p>
            ...
            <h3 class="title"><a href="javascript:openPop('<?php echo URL('mgr/plugins.pluginGuideView',array('json'=>'1'));?>','添加')" class="btn-general" rel="add"><span  rel="add">添加新类别</span></a>登录后引导关注(<span class="stress">所有登录您微购站点的微博用户第一次绑定时将提示关注下列分组内的微博帐号</span>)</h3>
			<div class="set-area">
