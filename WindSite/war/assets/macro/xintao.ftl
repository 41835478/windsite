...
<style>
#topnav, #topnav .guid, #topnav .guid li.selected, #topnav .guid li.selected a{background: transparent url(/assets/images/myxintao_v3_bg.gif) no-repeat scroll 2000px 2000px;}
...
.taoke-bar span, .taoke-bar-grey span{color:#404040;background: #F0F5F9 url(/assets/images/myxintao_v3_bg.gif) repeat-x scroll 0px -100px;display: block;font-size: 12px;font-weight: bold;line-height: 26px;margin: 1px;padding-left: 22px;}
.taoke-bar button.menu-open,.taoke-bar button.menu-close{background: url(/assets/images/myxintao_v3_bg.gif) no-repeat scroll 2000px 2000px;border:0px;cursor: pointer;height: 10px;left: 6px;overflow: hidden;overflow-x: hidden;overflow-y: hidden;position: absolute;text-indent: -999em;top: 9px;width: 10px;}
...
.menu-box .group li a, .menu-box .group li span a, .menu-box .group li ul li a{background: transparent url(/assets/images/myxintao_v3_bg.gif) no-repeat scroll 2000px 2000px;display: block;font-size: 12px;height: 20px;font-size: 12px;line-height: 20px;}
