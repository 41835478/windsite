...
<meta name="keywords" content="导购,淘宝,淘客,淘宝客,购物,电子商务,${sitetitle}">
<meta name="description" content="${sitetitle}">
<title>资讯- ${sitetitle}</title>
...
<div id="wrap">
	...
	<div id="main" class="clearfix">
		...
		<div id="blogs">
		<table width=100% class="page-bar"><tr><td align="left" width="500px">日志信息</td><td align="right" style="position:">
<div  class="page">共${page.totalCount}条&nbsp;&nbsp;&nbsp;&nbsp;<span class="page-info">${page.pageNo}/${page.totalPageCount}</span>
<a <#if page.pageNo==1>class="start-page"<#else>class="prev-page" href="/blogs<#switch type><#case 0>/me/${uid}.html?pid=${pid}&pageNo=${page.pageNo-1}<#break><#case 1>/friends/${uid}.html?pid=${pid}&pageNo=${page.pageNo-1}<#break><#case 2>/${uid}.html?pid=${pid}&pageNo=${page.pageNo-1}<#break></#switch>"</#if>><span>上一页</span></a>
<a <#if ((page.pageNo+1)<=page.totalPageCount)>class="next-page" href="/blogs<#switch type><#case 0>/me/${uid}.html?pid=${pid}&pageNo=${page.pageNo+1}<#break><#case 1>/friends/${uid}.html?pid=${pid}&pageNo=${page.pageNo+1}<#break><#case 2>/${uid}.html?pid=${pid}&pageNo=${page.pageNo+1}<#break></#switch>"<#else>class="end-page"</#if>><span>下一页</span></a></div> 
</td></tr></table>
		<dl>
			<#if blogs??&&blogs?size!=0>
			<#list blogs as b>
			<dt><a href="/blog/${uid}/${b.blogid}.html?pid=${pid}" target="_blank">${b.subject}</a><a class="nick" href="http://home.xintaonet.com/?${b.uid}" target="_blank">${b.username}</a><span class="dateline">${dateline(b.dateline)}</span></dt>
			</#list> 
			<#else>
