...
$_LANG = array();
///新淘网-淘宝API错误
$_LANG['pls__top__apiError'] = 'xintao/%s 返回API错误：%s(%s)';
$_LANG['pls__top__rstError'] = 'xintao/%s 返回列表为空。';
$_LANG['pls__top__Error'] = 'xintao/%s 返回错误的非数组类型数据！';
...
$_LANG['pls__component__abstract__apiError'] = '<div class="int-box"><span class="ico-load-fail"></span><p>%s（模块ID：%s）遇到问题：%s</p></div>';
...
$_LANG['modules__userPrivacyNotice__copyright'] = '此处信息均来自“%s”的新浪微博，由%s提供支持';
