...
$(function(){
	$('.favoriteForum').click(function(){
		var self = $(this);
		addMyFavoriteForum($(this).attr('fid'),'3',function(){
...
<dl class="categorys">
    <dd> <a id="forum" href="/router/member/forums/market">论坛阵地</a><a id="blog" href="/router/member/blogforums/market" class="selected" >博客阵地</a><a id="microblog" href="/router/member/microblogforums/market">微博阵地</a>
</dd>
</dl>
<td>
<td width=20px>
...
<table id="forum-list" width=100% border="0" cellspacing="1" cellpadding="4" style="background-color:#C5D5C5;">
	<TBODY>
	<tr><td bgcolor="F2FDE6" align="center" colspan=3><strong>博客综合</strong></td></tr>
	...
	<tr><td bgcolor="F2FDE6" align="center" colspan=3><strong>博客周边</strong></td></tr>
	...
	<tr><td bgcolor="F2FDE6" align="center" colspan=3><strong>酷博精选</strong></td></tr>
